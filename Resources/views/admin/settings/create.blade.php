...
@section('content')
    {!! Form::open(['route' => ['admin.warehouse.settings.store',$warehouse->id], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
            <div class="nav-tabs-custom">
               ...
               <div class="tab-content">
                    ...
                    {!! Form::normalSelect('item_required_field', trans('warehouse::settings.form.item_required_field'),$errors,
                            $itemCollumnList,null,['multiple'=>true,'class'=>'select2-selection select2-selection--multiple']) 
                            !!}
                    {!! Form::normalCheckbox('item_footer_search', trans('warehouse::settings.form.item_footer_search'),$errors,null) !!}
